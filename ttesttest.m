...
busdata=[1   1    1.06    0.0     0.0   0.0   122.2  0.0   0   0       0
...
% %                                       fprintf(' %7.5f', Fvsi(k)),)
%                                       
%                                       disp('Table using disp command'),disp(' k     nl(k)     nr(k)      Lmn(k)    Fvsi(k)')
%                                       disp([k', nl(k)', nr(k)', Lmn(k)', Fvsi(k)'])
% end 
